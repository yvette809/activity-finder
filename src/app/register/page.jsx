...
const RegisterModal = () => {
  ...
  return (
    <div className="p-8 rounded-md shadow-lg flex flex-col justify-center items-center">
      <h2 className="text-2xl font-bold mb-4 text-deep-green">Register</h2>
      <form onSubmit={handleRegister} className="text-gray-600 w-[50vw] ">
        <div className="mb-4">
          <label
            htmlFor="firstName"
        ...
        <div>
          ...
          <Link
            className="text-deep-green cursor-pointer font-bold mb-8"
            href="/login"
          >
            {" "}
            Login
